...
export class FinancialsController {
  ...
  @Get('summary')
  getSummary(@Query() q: any) { return this.service.getSummary(q); }
  ...
  @Put('commissions/pay-all/:userId')
  payAll(@Param('userId') userId: string) { return this.service.payAllCommissions(userId); }
